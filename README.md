...
- macOS
  - Apple Silicon/arm64: `icodex-aarch64-apple-darwin.tar.gz`
  - x86_64 (older Mac hardware): `icodex-x86_64-apple-darwin.tar.gz`
- Linux
  - x86_64: `icodex-x86_64-unknown-linux-musl.tar.gz`
  - arm64: `icodex-aarch64-unknown-linux-musl.tar.gz`

Each archive contains a single entry with the platform baked into the name (e.g., `icodex-x86_64-unknown-linux-musl`), so you likely want to rename it to `icodex` after extracting it.
