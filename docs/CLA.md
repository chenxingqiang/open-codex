# Individual Contributor License Agreement (v1.0, iEchor)
...
past and future “Contributions” submitted to the **iEchor Codex CLI project
(the “Project”)**.
...
## 2. Copyright License  
You grant **iEchor, Inc.** and all recipients of software distributed by the
...
## 3. Patent License  
You grant **iEchor, Inc.** and all recipients of the Project a perpetual,
