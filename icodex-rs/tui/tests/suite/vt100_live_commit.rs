...
fn live_001_commit_on_overflow() {
    ...
    let mut term = match icodex_tui::custom_terminal::Terminal::with_options(backend) {
        Ok(t) => t,
    ...
    let mut rb = icodex_tui::live_wrap::RowBuilder::new(20);
    ...
    icodex_tui::insert_history::insert_history_lines_to_writer(&mut term, &mut buf, lines);
