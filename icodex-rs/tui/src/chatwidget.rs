...
use icodex_core::config_types::Notifications;
use icodex_core::protocol::AgentMessageDeltaEvent;
use icodex_core::protocol::AgentMessageEvent;
use icodex_core::protocol::AgentReasoningDeltaEvent;
use icodex_core::protocol::AgentReasoningEvent;
use icodex_core::protocol::AgentReasoningRawContentDeltaEvent;
use icodex_core::protocol::AgentReasoningRawContentEvent;
use icodex_core::protocol::ApplyPatchApprovalRequestEvent;
use icodex_core::protocol::BackgroundEventEvent;
use icodex_core::protocol::ErrorEvent;
use icodex_core::protocol::Event;
use icodex_core::protocol::EventMsg;
use icodex_core::protocol::ExecApprovalRequestEvent;
use icodex_core::protocol::ExecCommandBeginEvent;
use icodex_core::protocol::ExecCommandEndEvent;
use icodex_core::protocol::InputItem;
use icodex_core::protocol::InputMessageKind;
use icodex_core::protocol::ListCustomPromptsResponseEvent;
use icodex_core::protocol::McpListToolsResponseEvent;
use icodex_core::protocol::McpToolCallBeginEvent;
use icodex_core::protocol::McpToolCallEndEvent;
use icodex_core::protocol::Op;
use icodex_core::protocol::PatchApplyBeginEvent;
use icodex_core::protocol::StreamErrorEvent;
use icodex_core::protocol::TaskCompleteEvent;
use icodex_core::protocol::TokenUsage;
use icodex_core::protocol::TokenUsageInfo;
use icodex_core::protocol::TurnAbortReason;
use icodex_core::protocol::TurnDiffEvent;
use icodex_core::protocol::UserMessageEvent;
use icodex_core::protocol::WebSearchBeginEvent;
use icodex_core::protocol::WebSearchEndEvent;
use icodex_protocol::parse_command::ParsedCommand;
...
use icodex_common::approval_presets::ApprovalPreset;
use icodex_common::approval_presets::builtin_approval_presets;
use icodex_common::model_presets::ModelPreset;
use icodex_common::model_presets::builtin_model_presets;
use icodex_core::AuthManager;
use icodex_core::ConversationManager;
use icodex_core::protocol::AskForApproval;
use icodex_core::protocol::SandboxPolicy;
use icodex_core::protocol_config_types::ReasoningEffort as ReasoningEffortConfig;
use icodex_file_search::FileMatch;
...
pub(crate) struct ChatWidget {
    ...
    icodex_op_tx: UnboundedSender<Op>,
...
impl ChatWidget {
    ...
    fn on_session_configured(&mut self, event: icodex_core::protocol::SessionConfiguredEvent) {
        self.bottom_pane
        ...
        // Ask icodex-core to enumerate custom prompts for this session.
    ...
    fn on_plan_update(&mut self, update: icodex_core::plan_tool::UpdatePlanArgs) {
    ...
    fn on_exec_command_output_delta(
        &mut self,
        _ev: icodex_core::protocol::ExecCommandOutputDeltaEvent,
    ) {
    ...
    fn on_patch_apply_end(&mut self, event: icodex_core::protocol::PatchApplyEndEvent) {
        let ev2 = event.clone();
        self.defer_or_handle(
    ...
    fn on_get_history_entry_response(
        &mut self,
        event: icodex_core::protocol::GetHistoryEntryResponseEvent,
    ) {
        let icodex_core::protocol::GetHistoryEntryResponseEvent {
            offset,
            log_id,
            entry,
        } = event;
    ...
    pub(crate) fn handle_patch_apply_end_now(
        &mut self,
        event: icodex_core::protocol::PatchApplyEndEvent,
    ) {
    ...
    pub(crate) fn new(
        ...
        let icodex_op_tx = spawn_agent(config.clone(), app_event_tx.clone(), conversation_manager);
    ...
    pub(crate) fn new_from_existing(
        common: ChatWidgetInit,
        conversation: std::sync::Arc<icodex_core::CodexConversation>,
        session_configured: icodex_core::protocol::SessionConfiguredEvent,
    ) -> Self {
        let ChatWidgetInit {
            config,
            frame_requester,
    ...
    fn dispatch_command(&mut self, cmd: SlashCommand) {
        ...
        match cmd {
            ...
            SlashCommand::Logout => {
                if let Err(e) = icodex_core::auth::logout(&self.config.icodex_home) {
            ...
            SlashCommand::TestApproval => {
                ...
                use icodex_core::protocol::ApplyPatchApprovalRequestEvent;
                use icodex_core::protocol::FileChange;
    ...
    pub(crate) fn handle_icodex_event(&mut self, event: Event) {
    ...
    fn dispatch_event_msg(&mut self, id: Option<String>, msg: EventMsg, from_replay: bool) {
        match msg {
            ...
            _ => {
                tracing::trace!("handle_icodex_event: {:?}", msg);
            }
        }
    ...
    pub(crate) fn open_model_popup(&mut self) {
        ...
        self.bottom_pane.show_selection_view(
            ...
            Some("Switch between iEchor models for this and future Codex CLI session".to_string()),
    ...
    /// Forward an `Op` directly to icodex.
    pub(crate) fn submit_op(&self, op: Op) {
        // Record outbound operation for session replay fidelity.
        crate::session_log::log_outbound_op(&op);
        if let Err(e) = self.icodex_op_tx.send(op) {
