...
use icodex_core::auth::read_openai_api_key_from_env;
...
impl AuthModeWidget {
    ...
    fn render_chatgpt_success_message(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            Line::from(vec![
                ...
                "\u{1b}]8;;https://github.com/iechor/icodex\u{7}Codex docs\u{1b}]8;;\u{7}".underlined(),
            ])
            .dim(),
            "".into(),
    ...
    fn render_api_key_entry(&self, area: Rect, buf: &mut Buffer, state: &ApiKeyInputState) {
        ...
        let mut intro_lines: Vec<Line> = vec![
            Line::from(vec![
                "> ".into(),
                "Use your own iEchor API key for usage-based billing".bold(),
            ]),
            "".into(),
    ...
    fn save_api_key(&mut self, api_key: String) {
        match login_with_api_key(&self.icodex_home, &api_key) {
            Ok(()) => {
                self.error = None;
    ...
    fn start_chatgpt_login(&mut self) {
        ...
        self.error = None;
        let opts = ServerOptions::new(self.icodex_home.clone(), CLIENT_ID.to_string());
