...
use icodex_core::config::set_project_trusted;
use icodex_core::git_info::resolve_root_git_project_for_trust;
...
impl TrustDirectoryWidget {
    fn handle_trust(&mut self) {
        ...
        if let Err(e) = set_project_trusted(&self.icodex_home, &target) {
