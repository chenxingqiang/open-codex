use icodex_common::elapsed::format_duration;
use icodex_common::elapsed::format_elapsed;
...
use icodex_core::protocol::McpInvocation;
...
use icodex_core::protocol::SessionConfiguredEvent;
...
use icodex_protocol::num_format::format_with_separators;
...
use icodex_common::create_config_summary_entries;
...
impl EventProcessor for EventProcessorWithHumanOutput {
    ...
    fn print_config_summary(&mut self, config: &Config, prompt: &str) {
        ...
        ts_println!(
            self,
            "iEchor Codex v{} (research preview)\n--------",
            VERSION
        );
        ...
        match msg {
            ...
            EventMsg::AgentMessageDelta(AgentMessageDeltaEvent { delta }) => {
                if !self.answer_started {
                    ts_println!(self, "{}\n", "icodex".style(self.italic).style(self.magenta));
            ...
            EventMsg::SessionConfigured(session_configured_event) => {
                ...
                ts_println!(
                    self,
                    "{} {}",
                    "icodex session".style(self.magenta).style(self.bold),
