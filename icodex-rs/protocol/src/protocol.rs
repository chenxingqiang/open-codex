...
pub enum Op {
    ...
    /// for a turn of a [`crate::icodex_conversation::CodexConversation`].
    UserTurn {
        /// User input items, see `InputItem`
        items: Vec<InputItem>,
    ...
    /// Request to shut down icodex instance.
    Shutdown,
}
    ...
    fn serialize_event() {
        ...
        let event = Event {
            ...
            msg: EventMsg::SessionConfigured(SessionConfiguredEvent {
                ...
                model: "icodex-mini-latest".to_string(),
