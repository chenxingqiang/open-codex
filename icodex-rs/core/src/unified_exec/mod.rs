...
mod tests {
    ...
    async fn unified_exec_persists_across_requests_jif() -> Result<(), UnifiedExecError> {
        ...
        manager
            .handle_request(UnifiedExecRequest {
                ...
                input_chunks: &[
                    "export".to_string(),
                    "CODEX_INTERACTIVE_SHELL_VAR=icodex\n".to_string(),
                ],
                timeout_ms: Some(2_500),
            })
            .await?;
        ...
        let out_2 = manager
            ...
            .await?;
        assert!(out_2.output.contains("icodex"));
    ...
    async fn multi_unified_exec_sessions() -> Result<(), UnifiedExecError> {
        ...
        manager
            .handle_request(UnifiedExecRequest {
                ...
                input_chunks: &["export CODEX_INTERACTIVE_SHELL_VAR=icodex\n".to_string()],
                timeout_ms: Some(2_500),
            })
            .await?;
        ...
        let out_3 = manager
            ...
            .await?;
        assert!(out_3.output.contains("icodex"));
    ...
    async fn requests_with_large_timeout_are_capped() -> Result<(), UnifiedExecError> {
        ...
        let result = manager
            .handle_request(UnifiedExecRequest {
                session_id: None,
                input_chunks: &["echo".to_string(), "icodex".to_string()],
        ...
        assert!(result.output.contains("icodex"));
    ...
    async fn completed_commands_do_not_persist_sessions() -> Result<(), UnifiedExecError> {
        ...
        let result = manager
            .handle_request(UnifiedExecRequest {
                session_id: None,
                input_chunks: &["/bin/echo".to_string(), "icodex".to_string()],
                timeout_ms: Some(2_500),
            })
            .await?;
