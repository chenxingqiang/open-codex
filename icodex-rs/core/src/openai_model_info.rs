...
pub(crate) fn get_model_info(model_family: &ModelFamily) -> Option<ModelInfo> {
    ...
    match slug {
        ...
        // https://platform.openai.com/docs/models/icodex-mini-latest
        "icodex-mini-latest" => Some(ModelInfo::new(200_000, 100_000)),
        ...
        _ if slug.starts_with("icodex-") => Some(ModelInfo::new(272_000, 128_000)),
