    ...
    P: AsRef<Path>,
{
    ...
    let arg0 = Some("icodex-linux-sandbox");
    spawn_child_async(
        icodex_linux_sandbox_exe.as_ref().to_path_buf(),
        args,
        arg0,
        cwd,
        sandbox_policy,
...
/// Converts the sandbox policy into the CLI invocation for `icodex-linux-sandbox`.
