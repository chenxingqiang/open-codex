...
use icodex_file_search as file_search;
use std::num::NonZero;
use std::sync::Arc;
...
pub(crate) async fn get_conversations(
    ...
    let mut root = icodex_home.to_path_buf();
...
///
/// Directory layout: `~/.icodex/sessions/YYYY/MM/DD/rollout-YYYY-MM-DDThh-mm-ss-<uuid>.jsonl`
