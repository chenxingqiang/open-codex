...
use icodex_protocol::protocol::ResumedHistory;
use icodex_protocol::protocol::RolloutItem;
use icodex_protocol::protocol::RolloutLine;
use icodex_protocol::protocol::SessionMeta;
use icodex_protocol::protocol::SessionMetaLine;
...
///
/// ```ignore
/// $ jq -C . ~/.icodex/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// $ fx ~/.icodex/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// ```
#[derive(Clone)]
...
impl RolloutRecorder {
    ...
    pub async fn list_conversations(
        ...
        get_conversations(icodex_home, page_size, cursor).await
    }
...
fn create_log_file(
    ...
    // Resolve ~/.icodex/sessions/YYYY/MM/DD and create it if missing.
    let timestamp = OffsetDateTime::now_local()
        .map_err(|e| IoError::other(format!("failed to get local time: {e}")))?;
    let mut dir = config.icodex_home.clone();
