...
impl From<ParsedCommand> for icodex_protocol::parse_command::ParsedCommand {
    fn from(v: ParsedCommand) -> Self {
        use icodex_protocol::parse_command::ParsedCommand as P;
        match v {
...
mod tests {
    ...
    fn supports_cd_and_rg_files() {
        assert_parsed(
            &shlex_split_safe("cd icodex-rs && rg --files"),
            vec![ParsedCommand::Search {
                cmd: "rg --files".to_string(),
                query: None,
                path: None,
