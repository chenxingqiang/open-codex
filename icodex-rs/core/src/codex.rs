...
use icodex_apply_patch::ApplyPatchAction;
use icodex_apply_patch::MaybeApplyPatchVerified;
use icodex_apply_patch::maybe_parse_apply_patch_verified;
use icodex_protocol::mcp_protocol::ConversationId;
use icodex_protocol::protocol::ConversationPathResponseEvent;
use icodex_protocol::protocol::ExitedReviewModeEvent;
use icodex_protocol::protocol::ReviewRequest;
use icodex_protocol::protocol::RolloutItem;
use icodex_protocol::protocol::TaskStartedEvent;
use icodex_protocol::protocol::TurnAbortReason;
use icodex_protocol::protocol::TurnAbortedEvent;
use icodex_protocol::protocol::TurnContextItem;
use futures::prelude::*;
...
use icodex_protocol::config_types::ReasoningEffort as ReasoningEffortConfig;
use icodex_protocol::config_types::ReasoningSummary as ReasoningSummaryConfig;
use icodex_protocol::custom_prompts::CustomPrompt;
use icodex_protocol::models::ContentItem;
use icodex_protocol::models::FunctionCallOutputPayload;
use icodex_protocol::models::LocalShellAction;
use icodex_protocol::models::ResponseInputItem;
use icodex_protocol::models::ResponseItem;
use icodex_protocol::models::ShellToolCallParams;
use icodex_protocol::protocol::InitialHistory;
...
impl Session {
    async fn new(
        ...
        let sess = Arc::new(Session {
            ...
            icodex_linux_sandbox_exe: config.icodex_linux_sandbox_exe.clone(),
    ...
    async fn run_exec_with_events<'a>(
        ...
        let result = process_exec_tool_call(
            ...
            exec_args.icodex_linux_sandbox_exe,
                        ...
                        msg: EventMsg::GetHistoryEntryResponse(
                            crate::protocol::GetHistoryEntryResponseEvent {
                                ...
                                entry: entry_opt.map(|e| {
                                    icodex_protocol::message_history::HistoryEntry {
...
async fn run_task(
    ...
    // Although from the perspective of icodex.rs, TurnDiffTracker has the lifecycle of a Task which contains
...
pub struct ExecInvokeArgs<'a> {
    ...
    pub icodex_linux_sandbox_exe: &'a Option<PathBuf>,
...
async fn handle_container_exec_with_params(
    ...
    let (params, safety, command_for_display) = match &apply_patch_exec {
        Some(ApplyPatchExec {
            ...
            let path_to_icodex = std::env::current_exe()
                .ok()
                .map(|p| p.to_string_lossy().to_string());
            let Some(path_to_icodex) = path_to_icodex else {
                return ResponseInputItem::FunctionCallOutput {
                    call_id,
                    output: FunctionCallOutputPayload {
                        content: "failed to determine path to icodex executable".to_string(),
                        success: None,
                    },
                };
            };
    ...
    let output_result = sess
        .run_exec_with_events(
            ...
            ExecInvokeArgs {
                ...
                icodex_linux_sandbox_exe: &sess.icodex_linux_sandbox_exe,
...
mod tests {
    ...
    fn make_session_and_context() -> (Session, TurnContext) {
        ...
        let icodex_home = tempfile::tempdir().expect("create temp dir");
        let config = Config::load_from_base_config_with_overrides(
            ConfigToml::default(),
            ConfigOverrides::default(),
            icodex_home.path().to_path_buf(),
        )
