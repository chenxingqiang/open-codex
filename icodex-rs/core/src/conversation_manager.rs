...
use crate::icodex::CodexSpawnOk;
use crate::icodex::INITIAL_SUBMIT_ID;
use crate::icodex_conversation::CodexConversation;
...
impl ConversationManager {
    ...
    async fn spawn_conversation(
        ...
        self.finalize_spawn(icodex, conversation_id).await
    }
    ...
    async fn finalize_spawn(
        ...
        // history.
        let event = icodex.next_event().await?;
        ...
        let conversation = Arc::new(CodexConversation::new(icodex));
        self.conversations
            .write()
            .await
