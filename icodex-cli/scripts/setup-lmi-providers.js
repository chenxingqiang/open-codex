...
class LMISetup {
  ...
  getConfigDir() {
    ...
    const configDir = join(homeDir, '.icodex');
...
` + lmiConfig;
  ...
  showUsageInstructions() {
    ...
    console.log('   icodex --model-provider lmi_openai');
    console.log('   icodex --model-provider lmi_anthropic');
    console.log('   icodex --model-provider lmi_google');
    console.log('   icodex --model-provider lmi_baidu');
    console.log('   icodex --model-provider lmi_alibaba');
