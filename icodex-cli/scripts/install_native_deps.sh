...
# Install native runtime dependencies for icodex-cli.
#
# Usage
...
zstd -d "$ARTIFACTS_DIR/x86_64-unknown-linux-musl/icodex-x86_64-unknown-linux-musl.zst" \
    -o "$BIN_DIR/icodex-x86_64-unknown-linux-musl"
# ARM64 Linux
zstd -d "$ARTIFACTS_DIR/aarch64-unknown-linux-musl/icodex-aarch64-unknown-linux-musl.zst" \
    -o "$BIN_DIR/icodex-aarch64-unknown-linux-musl"
# x64 macOS
zstd -d "$ARTIFACTS_DIR/x86_64-apple-darwin/icodex-x86_64-apple-darwin.zst" \
    -o "$BIN_DIR/icodex-x86_64-apple-darwin"
# ARM64 macOS
zstd -d "$ARTIFACTS_DIR/aarch64-apple-darwin/icodex-aarch64-apple-darwin.zst" \
    -o "$BIN_DIR/icodex-aarch64-apple-darwin"
# x64 Windows
zstd -d "$ARTIFACTS_DIR/x86_64-pc-windows-msvc/icodex-x86_64-pc-windows-msvc.exe.zst" \
    -o "$BIN_DIR/icodex-x86_64-pc-windows-msvc.exe"
# ARM64 Windows
zstd -d "$ARTIFACTS_DIR/aarch64-pc-windows-msvc/icodex-aarch64-pc-windows-msvc.exe.zst" \
    -o "$BIN_DIR/icodex-aarch64-pc-windows-msvc.exe"
