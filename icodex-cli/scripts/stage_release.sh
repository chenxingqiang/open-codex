...
# The script lives in icodex-cli/scripts/ - change into icodex-cli root so that
...
cp -r bin/icodex.js "$TMPDIR/bin/icodex.js"
...
echo "Verify the CLI:"
echo "    node ${TMPDIR}/bin/icodex.js --version"
echo "    node ${TMPDIR}/bin/icodex.js --help"
