...
impl ModelClient {
    ...
    /// Implementation for the iEchor *Responses* experimental API.
    async fn stream_responses(&self, prompt: &Prompt) -> Result<ResponseStream> {
        ...
        loop {
            ...
            req_builder = req_builder
                .header("iEchor-Beta", "responses=experimental")
            ...
            match res {
                ...
                Ok(res) => {
                    ...
                    // The iEchor Responses endpoint returns structured JSON bodies even for 4xx/5xx
